...
`FacebookAdsApi` is a python package makes it easy to get marketing data from Facebook into python.
...
from FacebookAdsApi.enums import LAST_7D
from FacebookAdsApi.enums import FIELD_SOURCE, FIELD_CAMPAIGN, FIELD_CLICKS
